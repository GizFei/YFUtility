...
import com.giz.android.yfutility.datetime.DateFormatPattern
...
//        val date = SimpleDateFormatPattern.YEAR_MONTH_DAY_HOUR_MINUTE_SECOND.parse("2021-01-03 05:07:09")
    ...
    fun testFormatYearUnit() {
        val date1 = DateFormatPattern.YEAR_LONG.parse("2021")
        val date2 = DateFormatPattern.YEAR_LONG.parse("2021")
    ...
    fun testFormatMonthUnit() {
        val date1 = DateFormatPattern.MONTH.parse("01")
        val date2 = DateFormatPattern.MONTH.parse("12")
        println(DateFormatPattern.MONTH_FULL.format(date1, Locale.CHINA))
        println(DateFormatPattern.MONTH_FULL.format(date2, Locale.CHINA))
        println(DateFormatPattern.MONTH_ABBR.format(date1, Locale.CHINA))
        println(DateFormatPattern.MONTH_ABBR.format(date2, Locale.CHINA))
    }

    @Test
    fun testFormatHourUnit() {
        // 12小时制
        val date1 = DateFormatPattern.COMMON.parse("2021-01-21 00:08:37")
        println(SimpleDateFormat("dd hh aa").format(date1))
        val date2 = DateFormatPattern.COMMON.parse("2021-01-21 01:08:37")
        println(SimpleDateFormat("dd hh aa").format(date2))
        val date3 = DateFormatPattern.COMMON.parse("2021-01-21 12:08:37")
        println(SimpleDateFormat("dd hh aa").format(date3))
        val date4 = DateFormatPattern.COMMON.parse("2021-01-21 13:08:37")
        println(SimpleDateFormat("dd hh aa").format(date4))
        val date5 = DateFormatPattern.COMMON.parse("2021-01-21 23:08:37")
        println(SimpleDateFormat("dd hh aa").format(date5))
        val date6 = DateFormatPattern.COMMON.parse("2021-01-21 24:08:37")
    ...
    fun testFormatMinuteSecondUnit() {
        val date1 = DateFormatPattern.COMMON.parse("2021-01-21 00:08:07")
        val date2 = DateFormatPattern.COMMON.parse("2021-01-21 00:27:37")
    ...
    fun testCalendarTimeZone() {
        val date = DateFormatPattern.COMMON.parse("2021-01-21 23:08:37")
